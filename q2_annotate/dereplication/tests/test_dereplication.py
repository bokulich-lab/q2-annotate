...
from q2_annotate.dereplication.derep import (
...
class TestDereplication(TestPluginBase):
    package = "q2_annotate.dereplication.tests"
    ...
    def setUp(self):
        ...
        self.bin_map = {
            ...
            "24dee6fe-9b84-45bb-8145-de7b092533a1": "24dee6fe-9b84-45bb-8145-de7b092533a1",
        }
